            ...
            <div class="p-6">
                ...
                <form wire:submit.prevent="saveChanges" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea wire:model="address" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-lnu-blue"></textarea>
