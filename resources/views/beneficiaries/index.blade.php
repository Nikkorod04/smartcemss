                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('beneficiaries.show', $beneficiary) }}" class="inline-flex items-center gap-1 px-3 py-1 text-sm text-lnu-blue hover:bg-blue-50 rounded-lg transition">
                                ...
                                <a href="{{ route('beneficiaries.edit', $beneficiary) }}" class="inline-flex items-center gap-1 px-3 py-1 text-sm text-orange-600 hover:bg-orange-50 rounded-lg transition">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <form method="POST" action="{{ route('beneficiaries.destroy', $beneficiary) }}" class="inline"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="inline-flex items-center gap-1 px-3 py-1 text-sm text-red-600 hover:bg-red-50 rounded-lg transition">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
