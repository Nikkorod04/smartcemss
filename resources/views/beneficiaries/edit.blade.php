<x-admin-layout header="Edit Beneficiary">
    <div class="max-w-full">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <!-- Form -->
            <form method="POST" action="{{ route('beneficiaries.update', $beneficiary) }}" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" 
                                :value="old('first_name', $beneficiary->first_name)" placeholder="Juan" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="middle_name" class="block mt-1 w-full" type="text" name="middle_name" 
                                :value="old('middle_name', $beneficiary->middle_name)" placeholder="de la Cruz" />
                        ...
                        <div>
                            ...
                            <x-text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" 
                                :value="old('last_name', $beneficiary->last_name)" placeholder="Santos" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="age" class="block mt-1 w-full" type="number" name="age" 
                                :value="old('age', $beneficiary->age)" placeholder="25" min="1" max="150" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="male" @if(old('gender', $beneficiary->gender) === 'male') selected @endif>Male</option>
                                <option value="female" @if(old('gender', $beneficiary->gender) === 'female') selected @endif>Female</option>
                                <option value="other" @if(old('gender', $beneficiary->gender) === 'other') selected @endif>Other</option>
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="marital_status" class="block mt-1 w-full" type="text" name="marital_status" 
                                :value="old('marital_status', $beneficiary->marital_status)" placeholder="Single, Married, etc." />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" 
                                :value="old('email', $beneficiary->email)" placeholder="juan@example.com" />
                        ...
                        <div>
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" 
                                :value="old('phone', $beneficiary->phone)" placeholder="+63 9XX XXX XXXX" />
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" 
                            :value="old('address', $beneficiary->address)" placeholder="123 Main Street" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="barangay" class="block mt-1 w-full" type="text" name="barangay" 
                                :value="old('barangay', $beneficiary->barangay)" placeholder="Barangay Name" />
                        ...
                        <div>
                            ...
                            <x-text-input id="municipality" class="block mt-1 w-full" type="text" name="municipality" 
                                :value="old('municipality', $beneficiary->municipality)" placeholder="City/Municipality" />
                        ...
                        <div>
                            ...
                            <x-text-input id="province" class="block mt-1 w-full" type="text" name="province" 
                                :value="old('province', $beneficiary->province)" placeholder="Province" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="community_id" name="community_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="{{ $community->id }}" @if(old('community_id', $beneficiary->community_id) == $community->id) selected @endif>
                                    {{ $community->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="beneficiary_category" class="block mt-1 w-full" type="text" name="beneficiary_category" 
                                :value="old('beneficiary_category', $beneficiary->beneficiary_category)" placeholder="e.g., Student, Parent, Senior" />
                        ...
                        <div class="mt-2 max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-3 bg-gray-50">
                            ...
                            <label class="flex items-center mb-2 cursor-pointer hover:bg-gray-100 p-2 rounded transition">
                                <input type="checkbox" name="program_ids[]" value="{{ $program->id }}" 
                                    @if(in_array($program->id, $selectedPrograms)) checked @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="monthly_income" class="block mt-1 w-full" type="number" name="monthly_income" 
                                :value="old('monthly_income', $beneficiary->monthly_income)" placeholder="0.00" step="0.01" min="0" />
                        ...
                        <div>
                            ...
                            <x-text-input id="occupation" class="block mt-1 w-full" type="text" name="occupation" 
                                :value="old('occupation', $beneficiary->occupation)" placeholder="e.g., Farmer, Teacher" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <select id="educational_attainment" name="educational_attainment" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="Elementary" @if(old('educational_attainment', $beneficiary->educational_attainment) === 'Elementary') selected @endif>Elementary</option>
                                <option value="High School" @if(old('educational_attainment', $beneficiary->educational_attainment) === 'High School') selected @endif>High School</option>
                                <option value="College" @if(old('educational_attainment', $beneficiary->educational_attainment) === 'College') selected @endif>College</option>
                                <option value="Graduate" @if(old('educational_attainment', $beneficiary->educational_attainment) === 'Graduate') selected @endif>Graduate</option>
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="number_of_dependents" class="block mt-1 w-full" type="number" name="number_of_dependents" 
                                :value="old('number_of_dependents', $beneficiary->number_of_dependents)" placeholder="0" min="0" max="20" />
                ...
                <div class="pb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="status" name="status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                            <option value="active" @if(old('status', $beneficiary->status) === 'active') selected @endif>Active</option>
                            <option value="inactive" @if(old('status', $beneficiary->status) === 'inactive') selected @endif>Inactive</option>
                        </select>
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" 
                            placeholder="Any additional remarks or notes...">{{ old('notes', $beneficiary->notes) }}</textarea>
                ...
                <div class="border-t border-gray-200 pt-6 flex gap-4">
                    ...
                    <a href="{{ route('beneficiaries.show', $beneficiary) }}" class="flex-1 px-6 py-3 bg-gray-200 text-gray-900 font-semibold rounded-lg hover:bg-gray-300 transition text-center">
                        Cancel
                    </a>
                </div>
            </form>
