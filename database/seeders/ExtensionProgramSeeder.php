    ...
    public function run(): void
    {
        ...
        $program1 = ExtensionProgram::firstOrCreate(
            ...
            [
                ...
                'planned_start_date' => Carbon::create(2025, 1, 15),
                'planned_end_date' => Carbon::create(2025, 12, 31),
                'target_beneficiaries' => 175,
                'beneficiary_categories' => json_encode([
                    'College Student Tutors' => 100,
                    'Youth Development Workers' => 75,
                    'Grade 1-2 Learners' => 1500,
                    'Parent Participants' => 800,
                ]),
                ...
                'status' => 'ongoing',
                'notes' => 'Program provides ₱500-645 daily stipends for tutors and ₱235 per session allowance for parents. Expanded nationwide after 2023 NCR pilot. Covers regions: Ilocos, Bicol, Western Visayas, Northern Mindanao, and CARAGA.',
        ...
        $program2 = ExtensionProgram::firstOrCreate(
            ...
            [
                ...
                'planned_start_date' => Carbon::create(2025, 4, 11),
                'planned_end_date' => Carbon::create(2026, 3, 31),
                'target_beneficiaries' => 150,
                'beneficiary_categories' => json_encode([
                    'Direct Teacher Participants' => 45,
                    'Indirect Teacher Beneficiaries' => 105,
                    'Students' => 2000,
                ]),
