...
class CommunityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'name.required' => 'School or Community name is required.',
            'name.min' => 'School or Community name must be at least 3 characters long.',
            'name.max' => 'School or Community name cannot exceed 255 characters.',
            'name.unique' => 'This school or community name already exists.',
            'name.regex' => 'School or Community name can only contain letters, numbers, spaces, and basic punctuation.',
